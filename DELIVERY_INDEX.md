...
| 13 | `docs/research-evidence-register.md` | 复查研究来源、引用等级和维护风险。 |
| 14 | `docs/authorized-transcript-workflow.md` | 如果后续有授权文本，按流程生成私有逐字稿、译文和公开学习材料。 |
| 15 | `site/index.html` | 最后用静态站预览学习者看到的完整入口。 |
